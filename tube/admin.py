...
from .models import Video,VideoView,VideoComment,VideoCommentReply,VideoCommentReplyToReply,VideoCategory,MyList,History,Notify,NotifyTarget,NotifyCategory,UserPolicy,Report,ReportCategory,VideoCommentRefuse,AdvertisingVideo,AdvertisingCategory,Topic,Activity,AdvertisingVideoView
...
class VideoAdmin(admin.ModelAdmin):
    ...
    # 指定したフィールドを表示、編集ができる
    list_display = [ "format_thumbnail","format_user","id","title","description","category","dt","comment_refuse","private","comment_approval" ]
